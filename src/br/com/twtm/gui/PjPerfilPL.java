...
public class PjPerfilPL extends javax.swing.JPanel {

    private Pessoa pj, eu;
    private VoltarAvancar va;
    private JPanel pnl;

    public PjPerfilPL(PessoaJuridica pj, Pessoa eu, VoltarAvancar va, JPanel pnl, JPanel topo) {
        initComponents();
        this.pj = pj;
        this.eu = eu;
        this.va = va;
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/twtm/imagens/star_16.png"))); // NOI18N
        jButton1.setText("Reputação");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbNomeCompleto, javax.swing.GroupLayout.DEFAULT_SIZE, 758, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        PeReputacaoJD d = new PeReputacaoJD(null, true, pj, eu);
        d.setVisible(true);
