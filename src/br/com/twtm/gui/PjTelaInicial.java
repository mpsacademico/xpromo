...
public class PjTelaInicial extends javax.swing.JFrame {
    
    private PjInteressesPL pnlInteressesPL;
    private PjOfertasPL pnlOfertasPL;
    private JFrame jfConversas, jfAmizades, jfConta;
    private PessoaJuridica pj;
    private int tipo = 0;
    private int filtroPressionado = 9;
    
    public PjTelaInicial(PessoaJuridica pj) {
        this.pj = pj;
        initComponents();
        ImageIcon icone48 = new ImageIcon(pj.perfil.getIcone().getImage().getScaledInstance(48, 48, Image.SCALE_DEFAULT));
        lbFoto.setIcon(icone48);
        icone48.getImage().flush();
        lbApelido.setText(pj.getNomeFantasia());
        lbEmail.setText(pj.getEmail());
        listarAmigos(9);
        verificaStatus(pj.login.getStatus());          
    }
    ...
    private void initComponents() {
        ...
        pnlGeral.setBackground(new java.awt.Color(204, 255, 204));
        ...
        btXpromo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btXpromoActionPerformed(evt);
            }
        });
    ...
    private void btOfertasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOfertasActionPerformed
        pnlGeral.removeAll();
        pnlOfertasPL = new PjOfertasPL(pj);
        pnlGeral.add(pnlOfertasPL);
        pnlGeral.repaint();
        pnlGeral.validate();
    ...
    private void btConversasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btConversasActionPerformed
        if (jfConversas == null) {
            jfConversas = new PeConversasJF(pj);
    ...
    private void btPerfilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPerfilActionPerformed
        PePerfilPessoal telaCadastroPerfil = new PePerfilPessoal(this, true, pj);
    ...
    private void btAmizadesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAmizadesActionPerformed
        if (jfAmizades == null) {
            jfAmizades = new PeAmizadesJF(pj);
    ...
    private void btInteressesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInteressesActionPerformed
        pnlGeral.removeAll();
        pnlInteressesPL = new PjInteressesPL(pj);
    ...
    private void mitAcessoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mitAcessoActionPerformed
        PeAcessoJD jdAcesso = new PeAcessoJD(this, true, pj.getLogin());
    ...
    private void lbStatusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbStatusMouseClicked
        alteraStatus(pj.login.getStatus());
    ...
    private void btXpromoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXpromoActionPerformed
        PeBancoJD t = new PeBancoJD(null, true);
        t.setVisible(true);
    }//GEN-LAST:event_btXpromoActionPerformed
    ...
    private void listarAmigos(int i) {
        ...
        for (Object amigo : amigos) {
            ...
            PeCartaoAmigoPL cartaoAmigo = new PeCartaoAmigoPL(p, pj);
            if (i > 3) {
